...
That said the results were dramatic enough to warrant sharing.  The Edison sipped power even with the WiFi radio continuously active.  With a maximum observed draw of 176 mA the unit we tested never exceeded 1 Watt.  The implications for battery life will be remarkable. The current measurement results convinced us to also conduct an empirical "real world" run-down test of the Edison on battery. The results are below.
